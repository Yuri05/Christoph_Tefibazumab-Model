# Tefibazumab-Model
Whole-body PBPK model of the antibody tefibazumab in healthy adults [1].
...
**The latest release of the snapshot of the model, the evaluation plan and the static content can be found [here](https://github.com/Open-Systems-Pharmacology/Tefibazumab-Model/releases/latest).**
